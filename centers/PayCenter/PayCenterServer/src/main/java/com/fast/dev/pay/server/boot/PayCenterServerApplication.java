package com.fast.dev.pay.server.boot;
...
@ComponentScan("com.fast.dev.pay.server.core")
@Import({MVCConfiguration.class, MVCResponseConfiguration.class})
@SpringBootApplication(exclude = {DataSourceAutoConfiguration.class})
public class PayCenterServerApplication extends ApplicationBootSuper {

    public static void main(String[] args) {
        run(PayCenterServerApplication.class, args);
    }
