...
public interface UserManagerService {
     ...
     *
     * @param uid    用户id
     * @param time   禁用的时间，单位毫秒
     * @param reason 理由
     * @return
     */
    @RequestMapping(value = "/ucenter/manager/disable", method = RequestMethod.POST)
    boolean disable(@RequestParam("uid") String[] uid, @RequestParam("time") long time, @RequestParam("reason") String reason);
     ...
     * @return
     */
    @RequestMapping(value = "/ucenter/manager/enable", method = RequestMethod.POST)
    boolean enable(@RequestParam("uid") String[] uid);
